...
class TestTranslateCommand:
    ...
    def test_execute_integration(self):
        ...
        with patch("algebras.commands.translate_command.execute") as mock_execute:
            ...
            mock_execute.assert_called_once_with(None, False, False, ui_safe=False, verbose=False, batch_size=None, max_parallel_batches=None, glossary_id=None, prompt_file=None, regenerate_from_scratch=False, config_file=None)
            ...
            mock_execute.assert_called_with("fr", True, False, ui_safe=False, verbose=False, batch_size=None, max_parallel_batches=None, glossary_id=None, prompt_file=None, regenerate_from_scratch=False, config_file=None)
